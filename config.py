...
#Supoort group @rexbotschat
# Bot Configuration
API_TOKEN = os.environ.get("API_TOKEN", "8328688592:AAEw0rJzDz_A4o5CL76UQue1DmV0xJ6u4WY")
# CantarellaBots
# Don't Remove Credit
# Telegram Channel @CantarellaBots
#Supoort group @rexbotschat
# MongoDB
MONGO_URL = os.environ.get("MONGO_URL", "mongodb+srv://yovibor563_db_user:<db_password>@kmx.okzw5g2.mongodb.net/?appName=kmx")
DB_NAME = "kmxbot"
# CantarellaBots
# Don't Remove Credit
# Telegram Channel @CantarellaBots
...
# Telegram Channel @CantarellaBots
#Supoort group @rexbotschat
CHANNEL_URL = os.environ.get("CHANNEL_URL", "https://t.me/Theprimevault01")
DEV_URL = os.environ.get("DEV_URL", "https://t.me/Theprimevault01")
